...
import { contentPopup as contentPopupNewTodolist, eventCreateTodo } from "./Dom/_newTodolist.js";
...
todolistAction.addEventListener("click", ({ target }) => {
    if (target.classList.contains("new-todolist")) {
        // set popup content
    ...
    // remove all todolist
    if (target.classList.contains("remove-all-todolist")) {
